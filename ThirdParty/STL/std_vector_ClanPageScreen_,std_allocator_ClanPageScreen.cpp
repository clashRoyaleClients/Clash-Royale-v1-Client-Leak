class std::vector<ClanPageScreen *,std::allocator<ClanPageScreen *>>
{
public:

    __int64 __fastcall std::vector<ClanPageScreen *>::resize(__int64 result, unsigned __int64 a2)
    {
      if ( (__int64)(*(_QWORD *)(result + 8) - *(_QWORD *)result) >> 3 <= a2 )
        return std::vector<ClanPageScreen *>::_M_fill_insert(result, *(void **)(result + 8));
      *(_QWORD *)(result + 8) = *(_QWORD *)result + 8 * a2;
      return result;
    }

    void __fastcall std::vector<ClanPageScreen *>::_M_fill_insert(
            __int64 a1,
            char *__src,
            unsigned __int64 a3,
            __int64 *a4)
...
}; // end class std::vector<ClanPageScreen *,std::allocator<ClanPageScreen *>>
