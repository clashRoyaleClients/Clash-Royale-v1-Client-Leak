class std::vector<DeviceLinkSubScreen *,std::allocator<DeviceLinkSubScreen *>>
{
public:

    __int64 __fastcall std::vector<DeviceLinkSubScreen *>::push_back(__int64 result, _QWORD *a2)
    {
      _QWORD *v3; // x1
    
      v3 = *(_QWORD **)(result + 8);
      if ( v3 == *(_QWORD **)(result + 16) )
        return std::vector<DeviceLinkSubScreen *>::_M_insert_aux(result, v3);
      *v3 = *a2;
      *(_QWORD *)(result + 8) += 8LL;
      return result;
    }

    void __fastcall std::vector<DeviceLinkSubScreen *>::_M_insert_aux(__int64 a1, char *__src, _QWORD *a3)
    {
      _QWORD *v6; // x8
      __int64 v7; // x8
      __int64 v8; // x19
...
}; // end class std::vector<DeviceLinkSubScreen *,std::allocator<DeviceLinkSubScreen *>>
