class std::vector<AllianceItem *,std::allocator<AllianceItem *>>
{
public:

    __int64 __fastcall std::vector<AllianceItem *>::push_back(__int64 result, _QWORD *a2)
    {
      _QWORD *v3; // x1
    
      v3 = *(_QWORD **)(result + 8);
      if ( v3 == *(_QWORD **)(result + 16) )
        return std::vector<AllianceItem *>::_M_insert_aux(result, v3);
      *v3 = *a2;
      *(_QWORD *)(result + 8) += 8LL;
      return result;
    }

    __int64 __fastcall std::vector<AllianceItem *>::resize(__int64 result, unsigned __int64 a2)
    {
      if ( (__int64)(*(_QWORD *)(result + 8) - *(_QWORD *)result) >> 3 <= a2 )
        return std::vector<AllianceItem *>::_M_fill_insert(result, *(void **)(result + 8));
      *(_QWORD *)(result + 8) = *(_QWORD *)result + 8 * a2;
      return result;
    }

    void __fastcall std::vector<AllianceItem *>::_M_insert_aux(__int64 a1, char *__src, _QWORD *a3)
    {
      _QWORD *v6; // x8
      __int64 v7; // x8
      __int64 v8; // x19
    ...
    void __fastcall std::vector<AllianceItem *>::_M_fill_insert(__int64 a1, char *__src, unsigned __int64 a3, __int64 *a4)
    {
      char *v6; // x19
      char *v8; // x22
      __int64 v9; // x8
...
}; // end class std::vector<AllianceItem *,std::allocator<AllianceItem *>>
