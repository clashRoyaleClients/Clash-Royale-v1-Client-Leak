class std::vector<MovieClip *,std::allocator<MovieClip *>>
{
public:

    __int64 __fastcall std::vector<MovieClip *>::push_back(__int64 result, _QWORD *a2)
    {
      _QWORD *v3; // x1
    
      v3 = *(_QWORD **)(result + 8);
      if ( v3 == *(_QWORD **)(result + 16) )
        return std::vector<MovieClip *>::_M_insert_aux(result, v3);
      *v3 = *a2;
      *(_QWORD *)(result + 8) += 8LL;
      return result;
    }

    void __fastcall std::vector<MovieClip *>::_M_insert_aux(__int64 a1, char *__src, _QWORD *a3)
    {
      _QWORD *v6; // x8
      __int64 v7; // x8
      __int64 v8; // x19
    ...
    _QWORD *__fastcall std::vector<MovieClip *>::resize(_QWORD *result, unsigned __int64 a2, __int64 a3)
    {
      __int64 v3; // [xsp+8h] [xbp-8h]
    
      v3 = a3;
      if ( (__int64)(result[1] - *result) >> 3 <= a2 )
        return (_QWORD *)std::vector<MovieClip *>::_M_fill_insert();
      result[1] = *result + 8 * a2;
      return result;
    }

    void __fastcall std::vector<MovieClip *>::_M_fill_insert(__int64 a1, char *a2, unsigned __int64 a3, __int64 *a4)
    {
      char *v6; // x19
      char *v8; // x22
      __int64 v9; // x8
...
}; // end class std::vector<MovieClip *,std::allocator<MovieClip *>>
