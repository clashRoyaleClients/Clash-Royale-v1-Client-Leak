class LogicArrayList<Font *>
{
public:

    __int64 __fastcall LogicArrayList<Font *>::add(__int64 result, __int64 *a2)
    {
      __int64 v3; // x19
      int v4; // w8
      unsigned int v5; // w8
      ...
      if ( v4 == *(_DWORD *)(result + 8) )
      {
        ...
        if ( v5 )
          ...
          v6 = 5;
        result = LogicArrayList<Font *>::ensureCapacity(result, v6);
        v4 = *(_DWORD *)(v3 + 12);
      }
      v7 = *a2;
      *(_DWORD *)(v3 + 12) = v4 + 1;
    ...
    __int64 __fastcall LogicArrayList<Font *>::remove(__int64 *a1, const char *a2)
    {
      __int64 v3; // x8
      const String *v4; // x1
      __int64 v5; // x9
    ...
    void __fastcall LogicArrayList<Font *>::ensureCapacity(__int64 a1, int a2)
    {
      __int64 v4; // x0
      __int64 v5; // x21
      __int64 *v6; // x0
